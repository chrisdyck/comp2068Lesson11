...
module.exports = "<h1>Hello {{ title }}</h1>\n\n<app-messages></app-messages>"
...
var WebService = /** @class */ (function () {
    function WebService(httpClient) {
        this.httpClient = httpClient;
    }
    WebService.prototype.getMessages = function () {
        return (this.httpClient.get('http://localhost:3000/messages').toPromise());
    };
...
module.exports = __webpack_require__(/*! D:\Georgian College\COMP2068\Lesson11\frontend\src\main.ts */"./src/main.ts");
